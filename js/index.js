...
var user=["David","Leon","Shelia","Jay","Shane","MariYappan","Prakash","Pari","Sivaram","Jayden","Rajalingam","Kate","Lemonta Davis"];
var cas={
  "David":"1000",
  "Leon":"2500",
  "Shelia":"1500",
...
//Options to pick from when logged in
function atm()
{
  ...
  if (j=="with")
      ...
      if ((h>g)&&(g>0))
        {
          var to=h-g;
        cas[name]=to;
          alert("You Have Recieved "+g)
            bac();
        }
     else
        {
         alert("This Amount Is To Excessive");
        }
 ...
 else if (j=="depo")
   {
    var to=Number(h)+Number(g);
     cas[name]=to;
     alert("Deposited"+g+" SuccessFully")
       bac();
   }
  else if (j=="pass")
    {
